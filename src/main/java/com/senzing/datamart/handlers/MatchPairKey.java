 ...
 * implementations of {@link #equals(Object)}, {@link #hashCode()}
 * and {@link #compareTo(MatchPairKey)}.  This class can handle
 * the match key and/or principle having <code>null</code> values
 * to indiciate "any" match key or principle, respectively.
 */
public class MatchPairKey implements Comparable<MatchPairKey> {
    ...
    /**
     * Gets the match key.  This may return <code>null</code>
     * if constructed with a <code>null</code> match key.
     * 
     * @return The associated match key, or <code>null</code> if
     *         no specific principle was associated.
     */
    ...
    /**
     * Gets the associated principle.  This may return <code>null</code>
     * if constructed with a <code>null</code> principle.
     * 
     * @return The associated principle, or <code>null</code> if no
     *         specific principle was associated.
     */
    ...
    /**
     * Implemented to handle comparing such that we sort first on principles
     * and then on match keys with <code>null</code> values sorting less-than
