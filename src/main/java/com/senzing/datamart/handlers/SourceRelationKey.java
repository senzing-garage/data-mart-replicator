...
public final class SourceRelationKey implements Comparable<SourceRelationKey> {
     ...
     * @param matchType   The {@link SzMatchType} describing the match type.
     * @param matchKey    The match key for the relationships.
     * @param revMatchKey The reverse match key for the relationships.
     * @param principle   The principle for the relationships.
     * 
     ...
     *                              <code>null</code>
     */
    public static Set<SourceRelationKey> variants(SzMatchType   matchType,
                                                  String        matchKey,
                                                  String        revMatchKey,
                                                  String        principle)
            throws NullPointerException 
    {
        ...
        if (!Objects.equals(matchKey, revMatchKey)) {
            set.add(new SourceRelationKey(matchType, revMatchKey, null));
            set.add(new SourceRelationKey(matchType, revMatchKey, principle));
        }
        return set;
    }
