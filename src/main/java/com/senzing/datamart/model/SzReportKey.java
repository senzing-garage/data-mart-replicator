...
public class SzReportKey implements Serializable {
                     ...
                     String       dataSource2)
  {
    if (dataSource1 == null && dataSource2 != null) {
      throw new IllegalArgumentException(
          "A second data source cannot be specified if the first data source "
              + "is null.  reportCode=[ " + reportCode + " ], statistic=[ "
              + statistic + "], dataSource1=[ " + dataSource1
  ...
  public SzReportKey(SzReportCode reportCode, SzReportStatistic statistic) {
    this(reportCode, statistic.toString());
  }
  ...
  public SzReportKey(SzReportCode       reportCode,
                     ...
                     String             dataSource2)
  {
    this(reportCode, statistic.toString(), dataSource1, dataSource2);
  }
  ...
  public static SzReportKey parse(String keyText) {
    try {
      ...
      if (tokens.length == 3) return new SzReportKey(code, stat, src1);
