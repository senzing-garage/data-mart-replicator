...
public class SzReportUpdate {
                                ...
                                long         entityId)
  {
    ...
    Objects.requireNonNull(statistic, "The statistic cannot be null");
    return new Builder(
        new SzReportKey(reportCode, statistic.toString()), entityId, null);
  }
                                ...
                                long         relatedId)
  {
    ...
    Objects.requireNonNull(statistic, "The statistic cannot be null");
    return new Builder(
        new SzReportKey(reportCode, statistic.toString()), entityId, relatedId);
  }
  ...
  public static class Builder {
    ...
    public SzReportUpdate build() {
      SzReportUpdate updater = new SzReportUpdate(
