...
public class SzRecordKey implements Comparable<SzRecordKey>
{
    ...
    /**
     * Implemented to order {@link SzRecordKey} instances first by data source
     * code and then by record ID. A <code>null</code> reference compares
     * less-than a non-null reference.
     *
     ...
     *           greater-than the specified instance, or zero (0) if they are
     *           equal.
     */
