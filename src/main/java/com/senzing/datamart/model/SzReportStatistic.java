...
public enum SzReportStatistic {
  ...
  public static class Formatter {
    ...
    /**
     * Parses an encoded statistic as an instance of {@link Formatter}.
     * If the specified parameter is <code>null</code> or an empty string
     * after trimming leading and trailing whitespace then <code>null</code>
     * is returned.
     * 
     * @param encodedStatistic The encoded statistic.
     *  
     * @return The parsed statistic as a {@link Formatter}, or <code>null</code>
     *         if the specified parameter is <code>null</code> or empty string.
     * 
     * @throws IllegalArgumentException If the specified encoded statistic is not
     *                                  a properly formatted statistic.
     */
    public static Formatter parse(String encodedStatistic) {
      if (encodedStatistic == null) return null;
      String text = encodedStatistic.trim();
      if (encodedStatistic.length() == 0) return null;
      ...
      if (index < 0) {
        ...
        throw new IllegalArgumentException(
            "Improperly formatted report statistic: " + encodedStatistic);
      } else {
      ...
      if (principle != null) formatter.principle(principle);
      if (matchKey != null) formatter.matchKey(matchKey);
