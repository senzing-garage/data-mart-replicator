...
public interface EntityRelationsReportsService extends ReportsService
{
     ...
     */
    String ENTITY_RELATIONS_COUNT_ENDPOINT = ENTITY_RELATIONS_PREFIX
            + "/{relationCount}";

    /**
     * The endpoint for the entities report based on entity relations count.
     */
    String ENTITY_RELATIONS_ENTITIES_ENDPOINT = ENTITY_RELATIONS_COUNT_ENDPOINT
            + "/entities";
        ...
        throws ReportsServiceException
    {
        ...
        try {
            ...
            return EntityRelationsReports.getEntityRelationsBreakdown(conn,
                    timers);
            ...
            throws ReportsServiceException
    {
        ...
        try {
            ...
            return EntityRelationsReports.getEntityRelationsCount(conn,
                    relationCount, timers);
            ...
            throws ReportsServiceException
    {
        ...
        try {
            ...
            return EntityRelationsReports.getEntityIdsForRelationCount(conn,
                    relationCount, entityIdBound, boundType,
