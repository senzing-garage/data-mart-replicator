...
public class SzRelationsPage implements Serializable {
    ...
    public String toString() {
        return "bound=[ " + this.getBound() + " ], boundType=[ "
                ...
                + this.getPageSize() + " ], sampleSize=[ "
                        + this.getSampleSize() + " ], pageMinimumValue=[ "
                + this.getPageMinimumValue() + " ], pageMaximumValue=[ "
                        + this.getPageMaximumValue()
                + " ], totalRelationCount=[ " + this.getTotalRelationCount()
                        + " ], beforePageCount=[ "
                + this.getBeforePageCount() + " ], afterPageCount=[ "
                        + this.getAfterPageCount() + " ], relations=[ "
                + this.getRelations() + " ]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(bound, other.bound) && boundType == other
                .boundType && pageSize == other.pageSize
                && Objects.equals(sampleSize, other.sampleSize)
                && Objects.equals(getPageMinimumValue(),
                        other.getPageMinimumValue())
                && Objects.equals(getPageMaximumValue(),
                        other.getPageMaximumValue())
                && totalRelationCount == other
                        .totalRelationCount && beforePageCount == other
                                .beforePageCount
                && afterPageCount == other.afterPageCount && Objects
                        .equals(relations, other.relations);
    }
}
