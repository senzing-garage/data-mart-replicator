...
public class SzSourceSummary implements Serializable
{
    ...
    /**
     * The number of records from this data source that did not match a record
     * from the same data source. This represents the number of records from the
     * data source that are effectively unique (not duplicated).
     */
    ...
    /**
     * Gets number of records from this data source that did not match a record
     * from the same data source. This represents the number of records from the
     * data source that are effectively unique (not duplicated).
     *
     ...
     * repository that did <b>not</b> match against any other record. This is
     * also the total number of entities that only have a single record.
     *
     * @param recordCount The total number of records that have been loaded to
    ...
    /**
     * Gets the {@link List} of {@link SzCrossSourceSummary} instances
     * describing the summary statistics between the associated data source
     * versus every data source (including itself).
     *
     ...
     *                       the associated data source versus every data
     *                       source.
     */
     ...
     *
     * @param crossSummary The {@link SzCrossSourceSummary} describing the
     *                     summary statistics between the associated data source
     *                     versus another specific data source.
     */
