...
public class SzReportEntity implements Serializable
{
    ...
    /**
     * The {@link SortedMap} of {@link Long} entity ID's identifying the
     ...
     *
     * @param recordCount The number of records that are resolved to this
     *                    entity.
     */
     ...
     *
     * @param relationCount The number of entities that are related to this
     *                      entity.
     */
    ...
    /**
     * Gets the {@link List} of {@link SzReportRecord} instances describing the
     * records in the entity.
     *
     * @return The {@link List} of {@link SzReportRecord} instances describing
    ...
    /**
     * Sets the {@link List} of {@link SzReportRecord} instances describing the
     * records in this entity. If two records exist in the {@link Collection}
     * with the same data source code and record ID then the later one replaces
     * the earlier one.
     *
    ...
    /**
     * Adds the specified {@link SzReportRecord} to the list of records for this
     * entity. If a record already exists for this entity with the same data
     * source code and record ID, then the specified record replaces the
     * existing one.
     *
     * @param record The {@link SzReportRecord} describing the record to be
     *               added.
     */
     ...
     * and record ID. If there is no such record in the entity then this method
     * has no effect.
     *
