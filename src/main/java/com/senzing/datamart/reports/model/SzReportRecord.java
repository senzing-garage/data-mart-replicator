...
{
    /**
     * The data source code identifying the data source from which the record
     * was loaded.
     */
    private String dataSource = null;

    /**
     * The record ID that uniquely identifies the record within the data source
     * from which it was loaded.
     */
    private String recordId = null;

    /**
     * The optional match key describing why the record merged into the entity
     * to which it belongs. This is
     * <code>null</code> if this record belongs to a
     * single-record entity or if it was the initial record of the first
     * multi-record entity to which it belonged (even if it later re-resolved
     * into a larger entity).
     */
    private String matchKey = null;

    /**
     * The optional principle describing why the record merged into the entity
     * to which it belongs. This is
     * <code>null</code> if this record belongs to a
     * single-record entity or if it was the initial record of the first
     * multi-record entity to which it belonged (even if it later re-resolved
    ...
    /**
     * Gets the data source code identifying the data source from which the
     * record was loaded.
     *
    ...
    /**
     * Gets the record ID that uniquely identifies the record within the data
    ...
    /**
     * Sets the record ID that uniquely identifies the record within the data
     * source from which it was loaded.
     *
     * @param recordId The record ID that uniquely identifies the record within
    ...
    /**
     * Gets the optional match key describing why the record merged into the
     * entity to which it belongs. This returns
     * <code>null</code> if this record belongs to a
     * single-record entity or if it was the initial record of the first
     * multi-record entity to which it belonged (even if it later re-resolved
     * into a larger entity).
     ...
     *             entity to which it belongs, or <code>null</code> if this
    ...
    /**
     * Sets the optional match key describing why the record merged into the
     * entity to which it belongs. Set this to
     * <code>null</code> if this record belongs to a
     * single-record entity or if it was the initial record of the first
     * multi-record entity to which it belonged (even if it later re-resolved
     * into a larger entity).
     *
     * @param matchKey The optional match key describing why the record merged
     *                 into the entity to which it belongs, or <code>null</code>
     *                 if this record belongs to a single-record entity or if it
     *                 was the initial record of the first multi-record entity
    ...
    /**
     * Gets the optional principle describing why the record merged into the
     * entity to which it belongs. This returns
     * <code>null</code> if this record belongs to a
     * single-record entity or if it was the initial record of the first
     * multi-record entity to which it belonged (even if it later re-resolved
    ...
    /**
     * Sets the optional principle describing why the record merged into the
     * entity to which it belongs. Set this to
     * <code>null</code> if this record belongs to a
     * single-record entity or if it was the initial record of the first
     * multi-record entity to which it belonged (even if it later re-resolved
     * into a larger entity).
     *
     * @param principle The optional principle describing why the record merged
     *                  into the entity to which it belongs, or
     *                  <code>null</code> if this record belongs to a
