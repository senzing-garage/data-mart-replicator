...
public class SzSourceLoadedStats implements Serializable
{
    ...
    /**
     * The number of records loaded for the data source that failed to match
     * against any other record in the repository.
     */
     ...
     * associated data source.
     *
     * @param recordCount The total number of records that have been loaded for
    ...
    /**
     * Gets the total number of entities that have at least one record from the
     * associated data source. This value doubles as the number of entities
     * having a record from the associated data source where that record is
     * single
     ...
     * associated data source where that record is single <b>only</b> record in
     * the entity.
     *
     * @param recordCount The total number of records that have been loaded for
     *                    the associated data source.
