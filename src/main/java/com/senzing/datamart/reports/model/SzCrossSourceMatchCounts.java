...
public class SzCrossSourceMatchCounts implements Serializable
{
     ...
     * match-key/principle combination that describe the entity and record
    ...
    /**
     * Adds the specified {@link SzMatchCounts} instance to the list of {@link
     * SzMatchCounts} instances describing the match counts for this instance,
     * replacing any existing instance with the same match key and principle
     * combination.
     *
     ...
     *
     * @param matchKey  The match key for the {@link SzMatchCounts} to remove,
     *                  or <code>null</code> if removing the statistics
     *                  associated with any match key.
