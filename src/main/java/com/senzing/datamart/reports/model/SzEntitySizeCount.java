...
public class SzEntitySizeCount implements Serializable
{
    ...
    /**
     * Gets the number of records indicating the size of the entities for which
     * the entity count is provided.
     *
     * @return The number of records indicating the size of the entities for
     *             which the entity count is provided.
     */
    ...
    /**
     * Sets the number of records indicating the size of the entities for which
     * the entity count is provided.
     *
     ...
     *                    the associated {@linkplain #getEntitySize() entity
     *                    size}.
     * 
