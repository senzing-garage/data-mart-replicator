...
public abstract class Scheduler
{
     ...
     * @return The {@link TaskBuilder} created to create and schedule a task
     *             with this instance.
     */
     ...
     * exists so that {@link TaskBuilder} can call back into the {@link
     * Scheduler} to actually schedule the task that has been built; however,
     * the public interface for scheduling tasks is through the {@link
     * TaskBuilder} obtained from
     * {@link #createTaskBuilder(String)}. The scheduled {@link Task} gets added
     * to the list of pending tasks that must be committed before having it
     ...
     * commit. Do not call {@link #commit()} until you are done creating tasks
     ...
     * {@link SchedulingService}. Once committed the {@link Scheduler} can no
     * longer be used. This method should be called at the conclusion of task
     * creation and scheduling. If the {@link Scheduler} has already been
     * committed then this method does nothing.
     *
     * @return The number of tasks that were scheduled.
     *
     * @throws ServiceExecutionException If a failure occurs scheduling the
     *                                   tasks with the {@link
     *                                   SchedulingService}.
     */
