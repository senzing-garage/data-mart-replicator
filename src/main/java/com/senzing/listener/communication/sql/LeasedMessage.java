...
/**
 * Provides a simple message implementation representing a message that has been
 * stored in a database table and leased for consumption.
 */
public class LeasedMessage implements Serializable
{
    ...
    /**
     * The millisecond UTC time for the expiration of the lease on this message.
     */
     ...
     * @param leaseExpiration The millisecond UTC time for the expiration of the
     *                        lease on this message.
     */
    ...
    /**
     * Gets the unique message ID that has been assigned to this message in the
     * database.
     * 
     * @return The unique message ID that has been assigned to this message in
     *             the database.
     */
     ...
     * will expire.
     * 
     * @return The millisecond UTC time indicating when the lease on this
     *             message will expire.
     */
