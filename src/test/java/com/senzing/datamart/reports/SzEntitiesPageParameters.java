 ...
 */
public class SzEntitiesPageParameters {
    /**
    ...
    /**
     * The entity ID bound value for pagination.
     */
    private String entityIdBound;
     ...
     */
    private SzEntitiesPage expectedPage;

    /**
     * Default constructor.
     */
    public SzEntitiesPageParameters() {
        this.repoType = null;
        this.entityIdBound = null;
        this.boundType = null;
        this.pageSize = null;
     ...
     */
    public String getEntityIdBound() {
        return this.entityIdBound;
    }
     ...
     */
    public void setEntityIdBound(String entityIdBound) {
        this.entityIdBound = entityIdBound;
    }
     ...
     */
    public SzEntitiesPage getExpectedPage() {
     ...
     */
    public void setExpectedPage(SzEntitiesPage expectedPage) {
    ...
    public String toString() {
        return "SzEntitiesPageParameters { "
            + "repoType=[ " + this.repoType
            + " ], entityIdBound=[ " + this.entityIdBound
